...
function setupHomeAuth() {
    ...
    try {
        ...
        if (oauthToken) {
            ...
            // Restore intended page if user logged in from another page
            try {
                ...
                if (returnUrl) {
                    ...
                    if (cleanReturn && cleanReturn !== window.location.pathname && cleanReturn !== '/' && cleanReturn !== '/index.html' && cleanReturn.startsWith('/')) {
                        setTimeout(() => {
